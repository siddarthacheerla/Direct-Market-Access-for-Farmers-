...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="input-group mb-1 ml-2 searchbox">
                <div class="input-group-prepend">
                    <div class="input-group-text"><i class="fas fa-search" style="font-size:20px;color:red; "></i></div>
                </div>
            ...
            <div class="dropdown p-2 settings ">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    if (isset($_SESSION['phonenumber'])) {
                        ...
                        echo "<a href='contactus.php' class='dropdown-item'  style='padding-right:-20px;'>contact us</a>";
                          echo "<a href='buyer_orders.php' class='dropdown-item'  style='padding-right:-20px;'>Order Status</a>";
    ...
    <div class="container"> <img src="b1.jpg" class="img-fluid firstimage d-block mx-auto" alt="Responsive image">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                    <p><u><a href="https://www.agrocraft.com/">Farmer's Mart Corporation</a></u> is a Multitrading Company for farmers ang traders</p>
                    <p class="h6">Copy All right Reversed.Farmer's Mart <a class="text-green ml-2" href="https://www.google.com" target="_blank"></a></p>
                </div>
                </hr>
            </div>
        </div>
