...
h3 span {
    background: #fff;  /* White background to hide the line */
    padding: 0 10px;
}
 ...
 <body>
      ...
      <body>
           ...
           <nav class="navbar navbar-expand-xl ">
                ...
                <div class=" flex-row-reverse left ">
                    ...
                    <a href="CartPage.php"> <i class="fa" style=" color:green ;font-size:20px;margin-top:-20px;margin-bottom:20px;">&#61562;</i></a> -->
                          <!-- <span id="icon" style="color:red"> 5 </span>
                </div>  -->
                     </div>
                     <!-- <div class="p-2 ml-5"><i class='far fa-user-circle' style='font-size:30px; color: green;'></i></div> -->
                     <a class="float-left" href="#">
                          <img src="agro2.png" class="float-left mr-5 ml-0 " alt="Logo" style="height:100px;">
                     </a>
                </div>
                ...
                <a class="float-left" href="farmerHomepage.php">
                     <img src="agro2.png" class="float-left mr-2 moblogo" alt="Logo" style="height:100px;">
                </a>
         ...
         <a href="farmerchat.php" onclick="toggleChatbot()">💬 Chat with Buyer</a>
...
<div style="display: flex; justify-content: center;">
    ...
    <div style="width: 30%; text-align: center; padding: 20px; border: 1px solid #ccc; border-radius: 10px; margin: 10px;">
        <strong>Crop Recommendation</strong>
        <p>Get recommended crops based on soil, nutrients, and weather</p>
        <form action="cropRecommendation.php" method="get">
                ...
                <div class="container">
                     ...
                     <div class="row">
                          <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                               <p><u><a href="https://www.Farmer's Mart .com/">Farmer's Mart Corporation</a></u> is a Multitrading Company for farmers ang traders</p>
                               <p class="h6">Copy All right Reversed.<a class="text-green ml-2" href="https://www.google.com" target="_blank">Farmer's Mart</a></p>
                          </div>
                          </hr>
                     </div>
                </div>
