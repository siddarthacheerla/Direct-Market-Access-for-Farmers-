...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['order_id'])) {
        ...
        if (isset($_POST['confirm'])) {
            ...
            $update_status = "UPDATE orders SET status='Rejected' WHERE order_id='$order_id'";
            mysqli_query($con, $update_status);
        }
    }
}
...
<body>
    ...
    <table class="table">
        ...
        if (isset($_SESSION['phonenumber'])) {
            ...
            if (!$run_price) {
                echo "<tr><td colspan='7'>Error fetching orders: " . mysqli_error($con) . "</td></tr>";
            } else {
                while ($p_price = mysqli_fetch_array($run_price)) {
                    ...
                    $payment_mode = isset($p_price['payment']) ? $p_price['payment'] : 'N/A';
        ...
        ?>
                    <tr>
                       ...
                       <td data-label="Payment Mode"><?php echo $payment_mode; ?></td>
        ...
        <form method="post" style="display:inline;">
            <input type="hidden" name="order_id" value="<?php echo $p_price['order_id']; ?>">
    ...
    <?php } ?>
        ...
        <?php
            ...
            echo "<tr><td colspan='7' style='text-align:center; font-weight:bold;'>Please Login First!</td></tr>";
        }
        ?>
        </tbody>
    </table>
